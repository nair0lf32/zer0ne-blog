...
{{ < post-img src="dogcat.png" alt="dogcat" style="width: 200px;" > }}
...
Needed to url encode it (burpsuite do that for us when we use the inspector panel)
and pass this as c parameter
...
Time to move around...we move backward and found second flag
...
First google about "diferents linux environments"
...
which give us a new root shell on second netcat listening on port 4444
