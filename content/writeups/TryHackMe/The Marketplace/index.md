...
{{< post-img src="market.png" alt="market" style="width: 200px;" >}}
...
Note that I think it was unrealistically fast for a Reflected Xss (you usually wait for people to click on your malicious link which may takes long)
...
```
Now we all would go straight to `password` column
...
Tried the article's demo method
...
Docker is a root service so we can mount it on our machine for root shell
...
Would recommend this marketplace 100% !
