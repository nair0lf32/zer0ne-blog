...
Get Reminded it's a medium box
...
Quick reminder of this box level
...
In all the weird stuff I got a base64 string (reference + lenght)
...
There is an interresting `auth_password` function
